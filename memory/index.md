...
- [SYNTHESIS-2026-02-21](synthesis-2026-02-21.md) — síntesis del día: métricas, logros, estado, reflexión — Keys: synthesis, daily, metrics, achievements
...
- [TRK-GATEWAY-001](tracking-gateway-uptime.md) — gateway uptime monitoring: estado, errores, logs, systemd, alertas — Keys: gateway, uptime, monitoring, health, systemd
...
- [REF-KNOWLEDGE-GRAPH-001](ref-knowledge-graph.md) — knowledge graph sin embeddings: tags, relaciones, cuándo implementar — Keys: knowledge-graph, embeddings, relations, structure
...
- [REF-ANTI-PATTERNS-001](ref-anti-patterns.md) — anti-patterns: nunca ejecutar destructivos, subagente ≠ permiso, commits sin propósito, over-documenting — Keys: anti-patterns, mistakes, warnings, safety
...
- [2026-02-22](2026-02-22.md) — hoy
- [2026-02-21](2026-02-21.md) — ayer
- [2026-02-20](2026-02-20.md) — anteayer
